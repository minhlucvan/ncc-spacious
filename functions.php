 ...
 */
function render_nothumbnail($html, $post_id, $post_thumbnail_id, $size, $attr) {
	if ( $html == '' ){
		$html = "<img src='".get_template_directory_uri()."/images/default-thumbnail-image.png'>";
	}
	$before = "<div class='post-image'>";
	$after = "</div>";
	return $before . $html . $after;
}
add_filter( 'post_thumbnail_html', 'render_nothumbnail', 200, 200);
